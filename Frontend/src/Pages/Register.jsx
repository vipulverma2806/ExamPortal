...
const Register = () => {
  ...
  const courses = ["M.C.A.", "B.C.A.", "B.Sc.", "M.Sc.", "B.Tech.", "M.Tech."];
    ...
    <div className="min-h-screen bg-gray-900 flex items-center">
      <div className="flex justify-center lg:justify-end items-center w-full lg:w-1/3">
        <form
          ...
          className="bg-gray-800 flex flex-col p-6  rounded-2xl space-y-4 max-w-sm w-full "
        >
          ...
          <select
            ...
            // value={courseName}
            required
            className=" w-full p-3 rounded-2xl text-gray-400  bg-gray-700"
          ><option value="" disabled selected hidden className="text-gray-400">Select Course</option>
